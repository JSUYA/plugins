...
class GroundOverlayBodyState extends State<GroundOverlayBody> {
  ...
  bool get _supportsGroundOverlayBearingAndZIndex => false;
  ...
  void _onGroundOverlayTapped() {
    switch (_placingType) {
      case _GroundOverlayPlacing.position:
        _changePosition();
      case _GroundOverlayPlacing.bounds:
        _changeBounds();
    }
  }
      ...
      children: <Widget>[
        ...
        Wrap(
          ...
          children: <Widget>[
            ...
            if (!kIsWeb && _supportsGroundOverlayBearingAndZIndex)
              TextButton(
