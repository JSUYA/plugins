...
/// The `GroundOverlayController` class wraps a [GGroundOverlay] and its tap behavior.
class GroundOverlayController {
  /// Creates a `GroundOverlayController`, which wraps a [GGroundOverlay] object and its tap behavior.
  ...
  /// GroundOverlay component's tap event.
  ...
  void update(util.GGroundOverlayOptions options) {
    ...
    _groundOverlay!
      ...
      ..map = (options.visible ?? false) ? 'map' : null
