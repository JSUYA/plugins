...
/// The Tizen implementation of [FlutterBluePlusPlatform].
final class FlutterBluePlusTizen extends FlutterBluePlusPlatform {
  ...
  // registration is invoked before runApp(), so the event stream must be
  // initialized lazily on first access instead of in the constructor.
  late final Stream<Map<dynamic, dynamic>> _events = _eventChannel
  ...
  static void register() {
    FlutterBluePlusPlatform.instance = FlutterBluePlusTizen();
  }
