...
// FlutterBluePlusTizenPlugin is a tiny ownership shim: it owns the
// `BluetoothManager` and the two Flutter channels, and forwards calls into
// the manager. All real work lives in `BluetoothManager`.
