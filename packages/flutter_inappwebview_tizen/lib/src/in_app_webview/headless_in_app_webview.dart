...
/// Object specifying creation parameters for creating a [TizenHeadlessInAppWebView].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformHeadlessInAppWebViewCreationParams] for
/// more information.
@immutable
class TizenHeadlessInAppWebViewCreationParams
    extends PlatformHeadlessInAppWebViewCreationParams {
  /// Creates a new [TizenHeadlessInAppWebViewCreationParams] instance.
  TizenHeadlessInAppWebViewCreationParams({
  ...
  /// Creates a [TizenHeadlessInAppWebViewCreationParams] instance based on [PlatformHeadlessInAppWebViewCreationParams].
  TizenHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
    PlatformHeadlessInAppWebViewCreationParams params,
  ) : this(
        controllerFromPlatform: params.controllerFromPlatform,
        webViewEnvironment:
            params.webViewEnvironment as TizenWebViewEnvironment?,
...
class TizenHeadlessInAppWebView extends PlatformHeadlessInAppWebView
  ...
  /// Constructs a [TizenHeadlessInAppWebView].
  TizenHeadlessInAppWebView(PlatformHeadlessInAppWebViewCreationParams params)
    : super.implementation(
        params is TizenHeadlessInAppWebViewCreationParams
            ? params
            : TizenHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
                params,
              ),
  ...
  @override
  TizenInAppWebViewController? get webViewController => _webViewController;

  dynamic _controllerFromPlatform;

  TizenHeadlessInAppWebViewCreationParams get _tizenParams =>
      params as TizenHeadlessInAppWebViewCreationParams;

  _init() {
    _webViewController = TizenInAppWebViewController(
      TizenInAppWebViewControllerCreationParams(id: id, webviewParams: params),
    );
  ...
  Future<void> run() async {
    throw UnsupportedError(
      'HeadlessInAppWebView is not implemented on flutter_inappwebview_tizen yet.',
    );
  }
  ...
  Future<void> dispose() async {
    ...
    _tizenParams.pullToRefreshController?.dispose();
    _tizenParams.findInteractionController?.dispose();
  }
}

extension InternalHeadlessInAppWebView on TizenHeadlessInAppWebView {
