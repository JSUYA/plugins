...
///Controls a WebView, such as an [InAppWebView] widget instance, a [TizenHeadlessInAppWebView] instance or [TizenInAppBrowser] WebView instance.
///
...
///callback. Instead, if you are using an [TizenInAppBrowser] instance, you can get it through the [TizenInAppBrowser.webViewController] attribute.
class TizenInAppWebViewController extends PlatformInAppWebViewController
  ...
  Set<TizenWebMessageChannel> _webMessageChannels = Set();
  Set<TizenWebMessageListener> _webMessageListeners = Set();
  ...
  TizenInAppBrowser? _inAppBrowser;
  ...
  @override
  late TizenWebStorage webStorage;
  ...
  static final TizenInAppWebViewController _staticValue =
      TizenInAppWebViewController(
        TizenInAppWebViewControllerCreationParams(id: null),
      );
  ...
  TizenInAppWebViewController.fromInAppBrowser(
    PlatformInAppWebViewControllerCreationParams params,
    MethodChannel channel,
    TizenInAppBrowser inAppBrowser,
  ...
  void _init(PlatformInAppWebViewControllerCreationParams params) {
    ...
    webStorage = TizenWebStorage(
      TizenWebStorageCreationParams(
        localStorage: TizenLocalStorage.defaultStorage(controller: this),
        sessionStorage: TizenSessionStorage.defaultStorage(controller: this),
      ),
    );
    ...
    if (params.webviewParams is PlatformInAppWebViewWidgetCreationParams) {
      ...
      if (keepAlive != null) {
        ...
        if (props == null) {
          ...
          _webMessageChannels =
              props.webMessageChannels as Set<TizenWebMessageChannel>;
          _webMessageListeners =
              props.webMessageListeners as Set<TizenWebMessageListener>;
  ...
  Future<void> _postWebMessageWithJavascript({
    ...
    if ((message.ports?.isNotEmpty ?? false)) {
      throw UnsupportedError(
        'postWebMessage with transferable ports is not implemented on flutter_inappwebview_tizen.',
      );
    }
    ...
    switch (call.method) {
      ...
      case "onPrintRequest":
        if ((webviewParams != null &&
          ...
          WebUri? uri = url != null ? WebUri(url) : null;
          TizenPrintJobController? printJob = printJobId != null
              ? TizenPrintJobController(
                  TizenPrintJobControllerCreationParams(id: printJobId),
                )
              : null;
...
""",
  ...
  @override
  Future<TizenPrintJobController?> printCurrentPage({
    ...
    if (jobId != null) {
      return TizenPrintJobController(
...
(function() {
  ...
  Future<CallAsyncJavaScriptResult?> callAsyncJavaScript({
    ...
    if (contentWorld != null && contentWorld.name != ContentWorld.PAGE.name) {
      throw UnsupportedError(
        'callAsyncJavaScript only supports ContentWorld.PAGE on flutter_inappwebview_tizen.',
      );
    }
    Map<String, dynamic> args = <String, dynamic>{};
  ...
  @override
  Future<TizenWebMessageChannel?> createWebMessageChannel() async {
    Map<String, dynamic> args = <String, dynamic>{};
    Map<String, dynamic>? result = (await channel?.invokeMethod(
      'createWebMessageChannel',
      args,
    ))?.cast<String, dynamic>();
    final webMessageChannel = TizenWebMessageChannel.static().fromMap(result);
  ...
  Future<void> addWebMessageListener(
    ...
    _webMessageListeners.add(webMessageListener as TizenWebMessageListener);
