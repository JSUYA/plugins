...
class TizenInAppWebViewWidget extends PlatformInAppWebViewWidget {
  ...
  TizenInAppWebViewWidgetCreationParams get _tizenParams =>
      params as TizenInAppWebViewWidgetCreationParams;

  TizenInAppWebViewController? _controller;

  TizenHeadlessInAppWebView? get _tizenHeadlessInAppWebView =>
      params.headlessWebView as TizenHeadlessInAppWebView?;
  ...
  void _onPlatformViewCreated(int id) {
    ...
    _tizenHeadlessInAppWebView?.internalDispose();
    ...
    _tizenParams.findInteractionController?.init(viewId);
    debugLog(
