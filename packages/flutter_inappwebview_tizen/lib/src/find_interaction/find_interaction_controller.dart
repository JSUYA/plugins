...
/// Object specifying creation parameters for creating a [TizenFindInteractionController].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformFindInteractionControllerCreationParams] for
/// more information.
@immutable
class TizenFindInteractionControllerCreationParams
    extends PlatformFindInteractionControllerCreationParams {
  /// Creates a new [TizenFindInteractionControllerCreationParams] instance.
  const TizenFindInteractionControllerCreationParams({
    super.onFindResultReceived,
  });

  /// Creates a [TizenFindInteractionControllerCreationParams] instance based on [PlatformFindInteractionControllerCreationParams].
  factory TizenFindInteractionControllerCreationParams.fromPlatformFindInteractionControllerCreationParams(
    // Recommended placeholder to prevent being broken by platform interface.
    // ignore: avoid_unused_constructor_parameters
    PlatformFindInteractionControllerCreationParams params,
  ) {
    return TizenFindInteractionControllerCreationParams(
...
class TizenFindInteractionController extends PlatformFindInteractionController
    with ChannelController {
  /// Constructs a [TizenFindInteractionController].
  TizenFindInteractionController(
    PlatformFindInteractionControllerCreationParams params,
  ) : super.implementation(
        params is TizenFindInteractionControllerCreationParams
            ? params
            : TizenFindInteractionControllerCreationParams.fromPlatformFindInteractionControllerCreationParams(
                params,
              ),
      );
...
extension InternalFindInteractionController on TizenFindInteractionController {
