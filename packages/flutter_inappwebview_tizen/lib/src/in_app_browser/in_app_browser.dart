...
/// Object specifying creation parameters for creating a [TizenInAppBrowser].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformInAppBrowserCreationParams] for
/// more information.
class TizenInAppBrowserCreationParams
    extends PlatformInAppBrowserCreationParams {
  /// Creates a new [TizenInAppBrowserCreationParams] instance.
  TizenInAppBrowserCreationParams({
    super.contextMenu,
  ...
  /// Creates a [TizenInAppBrowserCreationParams] instance based on [PlatformInAppBrowserCreationParams].
  factory TizenInAppBrowserCreationParams.fromPlatformInAppBrowserCreationParams(
    // Recommended placeholder to prevent being broken by platform interface.
    // ignore: avoid_unused_constructor_parameters
    PlatformInAppBrowserCreationParams params,
  ) {
    return TizenInAppBrowserCreationParams(
      contextMenu: params.contextMenu,
      pullToRefreshController: params.pullToRefreshController,
      findInteractionController:
          params.findInteractionController as TizenFindInteractionController?,
      initialUserScripts: params.initialUserScripts,
      windowId: params.windowId,
      webViewEnvironment: params.webViewEnvironment as TizenWebViewEnvironment?,
    );
  }

  @override
  final TizenFindInteractionController? findInteractionController;

  @override
  final TizenWebViewEnvironment? webViewEnvironment;
}

///{@macro flutter_inappwebview_platform_interface.PlatformInAppBrowser}
class TizenInAppBrowser extends PlatformInAppBrowser with ChannelController {
  @override
  final String id = IdGenerator.generate();

  /// Constructs a [TizenInAppBrowser].
  TizenInAppBrowser(PlatformInAppBrowserCreationParams params)
    : super.implementation(
        params is TizenInAppBrowserCreationParams
            ? params
            : TizenInAppBrowserCreationParams.fromPlatformInAppBrowserCreationParams(
                params,
              ),
      ) {
  ...
  static final TizenInAppBrowser _staticValue = TizenInAppBrowser(
    TizenInAppBrowserCreationParams(),
  );

  /// Provide static access.
  factory TizenInAppBrowser.static() {
    return _staticValue;
  }

  TizenInAppBrowserCreationParams get _tizenParams =>
      params as TizenInAppBrowserCreationParams;
  ...
  TizenInAppWebViewController? _webViewController;

  @override
  TizenInAppWebViewController? get webViewController {
  ...
  _init() {
    ...
    _webViewController = TizenInAppWebViewController.fromInAppBrowser(
      TizenInAppWebViewControllerCreationParams(id: id),
      channel!,
      this,
      this.initialUserScripts,
    );
    _tizenParams.findInteractionController?.init(id);
  }
  ...
  Map<String, dynamic> _prepareOpenRequest({
    ...
    args.putIfAbsent(
      ...
      () => _tizenParams.webViewEnvironment?.id,
    );
    return args;
  }
  ...
  Future<void> openUrlRequest({
    ...
    throw UnsupportedError(
      'InAppBrowser is not implemented on flutter_inappwebview_tizen yet. '
      'Use InAppWebView instead.',
    );
  }
...
extension InternalInAppBrowser on TizenInAppBrowser {
