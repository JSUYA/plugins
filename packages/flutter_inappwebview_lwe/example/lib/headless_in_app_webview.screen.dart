...
class _HeadlessInAppWebViewExampleScreenState
  ...
  static const String _unsupportedMessage =
      'HeadlessInAppWebView is not implemented for flutter_inappwebview_lwe yet.';
  ...
  void _showUnsupported(String action) {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text(_unsupportedMessage)));
  }
        ...
        child: Column(
          children: <Widget>[
            ...
            const Padding(
              ...
              child: Text(_unsupportedMessage, textAlign: TextAlign.center),
            ),
          ],
        ),
      ),
