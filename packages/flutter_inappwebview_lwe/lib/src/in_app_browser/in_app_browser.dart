...
/// Object specifying creation parameters for creating a [LweInAppBrowser].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformInAppBrowserCreationParams] for
/// more information.
class LweInAppBrowserCreationParams extends PlatformInAppBrowserCreationParams {
  /// Creates a new [LweInAppBrowserCreationParams] instance.
  LweInAppBrowserCreationParams({
    super.contextMenu,
  ...
  /// Creates a [LweInAppBrowserCreationParams] instance based on [PlatformInAppBrowserCreationParams].
  factory LweInAppBrowserCreationParams.fromPlatformInAppBrowserCreationParams(
    // Recommended placeholder to prevent being broken by platform interface.
    // ignore: avoid_unused_constructor_parameters
    PlatformInAppBrowserCreationParams params,
  ) {
    return LweInAppBrowserCreationParams(
      contextMenu: params.contextMenu,
      pullToRefreshController: params.pullToRefreshController,
      findInteractionController:
          params.findInteractionController as LweFindInteractionController?,
  ...
  @override
  final LweFindInteractionController? findInteractionController;
...
class LweInAppBrowser extends PlatformInAppBrowser with ChannelController {
  @override
  final String id = IdGenerator.generate();

  /// Constructs a [LweInAppBrowser].
  LweInAppBrowser(PlatformInAppBrowserCreationParams params)
    : super.implementation(
        params is LweInAppBrowserCreationParams
            ? params
            : LweInAppBrowserCreationParams.fromPlatformInAppBrowserCreationParams(
                params,
              ),
      ) {
  ...
  static final LweInAppBrowser _staticValue = LweInAppBrowser(
    LweInAppBrowserCreationParams(),
  );

  /// Provide static access.
  factory LweInAppBrowser.static() {
    return _staticValue;
  }

  LweInAppBrowserCreationParams get _lweParams =>
      params as LweInAppBrowserCreationParams;
  ...
  LweInAppWebViewController? _webViewController;

  @override
  LweInAppWebViewController? get webViewController {
  ...
  _init() {
    ...
    _webViewController = LweInAppWebViewController.fromInAppBrowser(
      LweInAppWebViewControllerCreationParams(id: id),
      channel!,
      this,
      this.initialUserScripts,
    );
    _lweParams.findInteractionController?.init(id);
  }
  ...
  Map<String, dynamic> _prepareOpenRequest({
    ...
    args.putIfAbsent(
      ...
      () => _lweParams.webViewEnvironment?.id,
    );
    return args;
  }
  ...
  Future<void> openUrlRequest({
    ...
    throw UnsupportedError(
      'InAppBrowser is not implemented on flutter_inappwebview_lwe yet. '
...
extension InternalInAppBrowser on LweInAppBrowser {
