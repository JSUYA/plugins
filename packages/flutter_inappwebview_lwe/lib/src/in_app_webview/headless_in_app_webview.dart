...
/// Object specifying creation parameters for creating a [LweHeadlessInAppWebView].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformHeadlessInAppWebViewCreationParams] for
/// more information.
@immutable
class LweHeadlessInAppWebViewCreationParams
    extends PlatformHeadlessInAppWebViewCreationParams {
  /// Creates a new [LweHeadlessInAppWebViewCreationParams] instance.
  LweHeadlessInAppWebViewCreationParams({
  ...
  /// Creates a [LweHeadlessInAppWebViewCreationParams] instance based on [PlatformHeadlessInAppWebViewCreationParams].
  LweHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
...
class LweHeadlessInAppWebView extends PlatformHeadlessInAppWebView
  ...
  /// Constructs a [LweHeadlessInAppWebView].
  LweHeadlessInAppWebView(PlatformHeadlessInAppWebViewCreationParams params)
    : super.implementation(
        params is LweHeadlessInAppWebViewCreationParams
            ? params
            : LweHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
                params,
              ),
  ...
  @override
  LweInAppWebViewController? get webViewController => _webViewController;

  dynamic _controllerFromPlatform;

  LweHeadlessInAppWebViewCreationParams get _lweParams =>
      params as LweHeadlessInAppWebViewCreationParams;

  _init() {
    _webViewController = LweInAppWebViewController(
      LweInAppWebViewControllerCreationParams(id: id, webviewParams: params),
    );
  ...
  Future<void> run() async {
    throw UnsupportedError(
      'HeadlessInAppWebView is not implemented on flutter_inappwebview_lwe yet.',
    );
  }
  ...
  Future<void> dispose() async {
    ...
    _lweParams.pullToRefreshController?.dispose();
    _lweParams.findInteractionController?.dispose();
  }
}

extension InternalHeadlessInAppWebView on LweHeadlessInAppWebView {
