...
/// this class.
class LweInAppWebViewWidgetCreationParams
    extends PlatformInAppWebViewWidgetCreationParams {
  LweInAppWebViewWidgetCreationParams({
  ...
  /// Constructs a [LweInAppWebViewWidgetCreationParams] using a
  /// [PlatformInAppWebViewWidgetCreationParams].
  LweInAppWebViewWidgetCreationParams.fromPlatformInAppWebViewWidgetCreationParams(
...
class LweInAppWebViewWidget extends PlatformInAppWebViewWidget {
  /// Constructs a [LweInAppWebViewWidget].
  ///
  ///{@macro flutter_inappwebview_platform_interface.PlatformInAppWebViewWidget}
  LweInAppWebViewWidget(PlatformInAppWebViewWidgetCreationParams params)
    : super.implementation(
        params is LweInAppWebViewWidgetCreationParams
            ? params
            : LweInAppWebViewWidgetCreationParams.fromPlatformInAppWebViewWidgetCreationParams(
                params,
              ),
  ...
  LweInAppWebViewWidgetCreationParams get _lweParams =>
      params as LweInAppWebViewWidgetCreationParams;

  LweInAppWebViewController? _controller;

  LweHeadlessInAppWebView? get _lweHeadlessInAppWebView =>
      params.headlessWebView as LweHeadlessInAppWebView?;
  ...
  Widget build(BuildContext context) {
    ...
    return TizenView(
      key: params.key,
      viewType: 'com.pichillilorenzo/flutter_inappwebview_lwe',
      layoutDirection: params.layoutDirection,
      gestureRecognizers: params.gestureRecognizers,
  ...
  void _onPlatformViewCreated(int id) {
    ...
    _lweHeadlessInAppWebView?.internalDispose();
    _controller = LweInAppWebViewController(
      PlatformInAppWebViewControllerCreationParams(
        id: viewId,
        webviewParams: params,
      ),
    );
    _lweParams.findInteractionController?.init(viewId);
    debugLog(
