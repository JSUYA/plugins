...
/// Object specifying creation parameters for creating a [LweFindInteractionController].
///
/// When adding additional fields make sure they can be null or have a default
/// value to avoid breaking changes. See [PlatformFindInteractionControllerCreationParams] for
/// more information.
@immutable
class LweFindInteractionControllerCreationParams
    extends PlatformFindInteractionControllerCreationParams {
  /// Creates a new [LweFindInteractionControllerCreationParams] instance.
  const LweFindInteractionControllerCreationParams({
    super.onFindResultReceived,
  });

  /// Creates a [LweFindInteractionControllerCreationParams] instance based on [PlatformFindInteractionControllerCreationParams].
  factory LweFindInteractionControllerCreationParams.fromPlatformFindInteractionControllerCreationParams(
    // Recommended placeholder to prevent being broken by platform interface.
    // ignore: avoid_unused_constructor_parameters
    PlatformFindInteractionControllerCreationParams params,
  ) {
    return LweFindInteractionControllerCreationParams(
...
class LweFindInteractionController extends PlatformFindInteractionController
    with ChannelController {
  /// Constructs a [LweFindInteractionController].
  LweFindInteractionController(
    PlatformFindInteractionControllerCreationParams params,
  ) : super.implementation(
        params is LweFindInteractionControllerCreationParams
            ? params
            : LweFindInteractionControllerCreationParams.fromPlatformFindInteractionControllerCreationParams(
                params,
              ),
      );
...
extension InternalFindInteractionController on LweFindInteractionController {
