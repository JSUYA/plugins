...
import 'tizen_view_platform_interface.dart';

/*
class TizenView {
  Future<String?> getPlatformVersion() {
    return TizenViewPlatform.instance.getPlatformVersion();
  }
}
*/
...
class TizenViewController extends PlatformViewController {
  TizenViewController._({
    ...
    bool waitingForSize = true,
        ...
        _state = waitingForSize
            ? _TizenPlatformViewState.waitingForSize
            : _TizenPlatformViewState.creating;
  ...
  _TizenPlatformViewState _state;
  ...
  Future<Size> setSize(Size size) async {
    assert(_state != _TizenPlatformViewState.disposed,
        'Tizen view is disposed. View id: $viewId');
    assert(_state != _TizenPlatformViewState.waitingForSize,
  ...
  Future<void> setOffset(Offset off) async {
    ...
    if (_state != _TizenPlatformViewState.created) {
      return;
    }
  ...
  Future<void> create({Size? size}) async {
    ...
    _state = _TizenPlatformViewState.created;
  ...
  bool get isCreated => _state == _TizenPlatformViewState.created;
  ...
  Future<void> setLayoutDirection(TextDirection layoutDirection) async {
    ...
    if (_state == _TizenPlatformViewState.waitingForSize) {
      return;
    }
  ...
  Future<void> dispose() async {
    if (_state == _TizenPlatformViewState.creating ||
        _state == _TizenPlatformViewState.created) {
      await _sendDisposeMessage();
    }
    _platformViewCreatedCallbacks.clear();
    _state = _TizenPlatformViewState.disposed;
